...
\begin{frame}\frametitle{FAQs}
	...
	No problem, just judge if you think this patent might have something to contribute to automation. If you're not sure \textit{beyond reasonable doubt} (to borrow such a legal term), please indicate this in the comment box.
	\end{itemize}
\end{frame}
