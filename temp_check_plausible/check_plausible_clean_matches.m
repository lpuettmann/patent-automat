function check_plausible_clean_matches(year_start, year_end)
...
for ix_year = year_start:year_end
    ...
    % Load matches
    load_file_name = horzcat('check_plausible_patent_keyword_appear_', num2str(ix_year));
    load(load_file_name)
    ...
    % Save
    save_name = horzcat('check_plausible_patsearch_results_', num2str(ix_year), '.mat');
    matfile_path_save = fullfile('temp_check_plausible', save_name);
