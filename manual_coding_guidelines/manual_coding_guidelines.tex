...
\texttt{manclass\textunderscore LukasPuettmann\textunderscore 2015-05-11.xlsx}\\[0.3cm]
		\item and then send it back to us in an email to \href{mailto:katja.mann@uni-bonn.de}{\texttt{katja.mann@uni-bonn.de}} or \href{mailto:lukas.puettmann@uni-bonn.de}{\texttt{lukas.puettmann@uni-bonn.de}}		
	\end{itemize}
\end{frame}


\begin{frame}\frametitle{Some empirical probabilities}
So far, the different fields were marked the following frequencies:
	\begin{itemize}	
