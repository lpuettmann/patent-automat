...
\begin{frame}\frametitle{Definition}
	...
	\item An \textit{automat} is a \textbf{device}$^1$ that carries out a \textbf{process}$^2$ \textbf{independently}$^3$.
		...
		\item What we are not looking for: 
			...
			\item parts of computers or of software that does not directly contribute to automation
...
\begin{itemize}
	...
	\item Even if your not sure and you write a 1 to ``ighly uncertain" please still make the decisions on whether the patent is an automation patent and whether it is manual or cognitive.
