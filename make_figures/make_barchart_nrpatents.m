...
fprintf(FID,'\\small\n');
fprintf(FID,'\\item $^1$: automation patents are defined as patents with at least one keyword match; both categories exclude named patents such as design patents.\n');
