...
%     fprintf(FID, '%d & %d & %d & %3.2f \\tabularnewline\n', ix_year, total_alg1_per_year(t), nr_patents_per_year(t), total_alg1_per_year(t) / nr_patents_per_year(t));
...
for t=1:13
    ...
    fprintf(FID,'%d & %d & %d & %3.1f & & %d & %d & %d & %3.1f & & %d & %d & %d & %3.1f \\tabularnewline[0.1cm]\n', ix_year, total_alg1_per_year(t), nr_patents_per_year(t), total_alg1_per_year(t)/nr_patents_per_year(t)*100, ix_year + addyear, total_alg1_per_year(t + addyear), nr_patents_per_year(t + addyear), total_alg1_per_year(t + addyear)/nr_patents_per_year(t + addyear)*100, ix_year + addyear2, total_alg1_per_year(t + addyear2), nr_patents_per_year(t + addyear2), total_alg1_per_year(t + addyear2)/nr_patents_per_year(t + addyear2)*100);
end
 
fprintf(FID,'& & & & & & & & & & 2015$^3$ & %d & %d & %3.1f  \\tabularnewline[0.1cm]\n', total_alg1_per_year(end), nr_patents_per_year(end), total_alg1_per_year(end)/nr_patents_per_year(end)*100);
fprintf(FID,'& & & & & & & & & & \\textbf{Total} & \\textbf{%d} & \\textbf{%d} & \\textbf{%3.1f} \\tabularnewline[0.1cm]\n', sum(total_alg1_per_year), sum(nr_patents_per_year), sum(total_alg1_per_year)/sum(nr_patents_per_year)*100);
