function plot_pat1m_over_nrpatents_weekly(year_start, year_end, pick_k)
...
raw_series = allyr_patstats.total_pat1m_week(:, pick_k);
...
% Export to pdf
% -----------------------------------------------------------------------
print_pdf_name = horzcat('output/pat1m_over_nrpatents_weekly_', num2str(year_start), '-',  num2str(year_end),'.pdf');
