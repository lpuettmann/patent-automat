...
plot(plottime, classifstat_yrly.accuracy, 'Color', gray2, ...
    'Linewidth', lwidth)
hold on
plot(plottime, classifstat_yrly.fmeasure, 'Color', gray3, ...
    'Linewidth', lwidth)
...
annotation(figureHandle,'textarrow',[0.680155306298545 0.641932700603971],...
    [0.390988372093023 0.48546511627907],'TextEdgeColor','none',...
    'HorizontalAlignment','left',...
    'String','F1-measure',...
    'HeadStyle','none',...
    'FontSize', 14, ...
...
% Export to pdf
% -----------------------------------------------------------------------
print_pdf_name = 'output/accuracy_and_fmeasure_yrly.pdf';
