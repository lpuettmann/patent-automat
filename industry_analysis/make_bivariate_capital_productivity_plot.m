function make_bivariate_capital_productivity_plot(fyr_start, fyr_end, industry_sumstats, ...
...
set(gcf, 'Position', [100 200 1550 700]) % in vector: left bottom width height
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_capital_productivity.pdf', '-dpdf', '-r0')
