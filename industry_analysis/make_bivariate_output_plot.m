function make_bivariate_output_plot(fyr_start, fyr_end, industry_sumstats, ...
...
set(gcf, 'Position', [100 200 1500 750]) % in vector: left bottom width height
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_output.pdf', '-dpdf', '-r0')
