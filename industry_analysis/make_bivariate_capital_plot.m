function make_bivariate_capital_plot(fyr_start, fyr_end, industry_sumstats, ...
...
%     end
    ...
    ylabel('Capital', 'FontSize', font_size)
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_capital.pdf', '-dpdf', '-r0')
