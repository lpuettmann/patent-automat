function make_bivariate_labor_cost_plot(fyr_start, fyr_end, industry_sumstats, ...
...
%     end
    ...
    ylabel('Labor cost', 'FontSize', font_size)
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_labor_cost.pdf', '-dpdf', '-r0')
