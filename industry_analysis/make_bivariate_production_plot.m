function make_bivariate_production_plot(fyr_start, fyr_end, industry_sumstats, ...
...
%     end
    ...
    ylabel('Production', 'FontSize', font_size)
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_production.pdf', '-dpdf', '-r0')
