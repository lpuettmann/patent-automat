function make_bivariate_labor_productivity_plot(fyr_start, fyr_end, industry_sumstats, ...
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_labor_productivity.pdf', '-dpdf', '-r0')
