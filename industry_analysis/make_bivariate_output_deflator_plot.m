function make_bivariate_output_deflator_plot(fyr_start, fyr_end, industry_sumstats, ...
...
%     end
    ...
    ylabel('Output deflator', 'FontSize', font_size)
...
% Export to pdf
print(figureHandle, 'output/bivariate_autompat_vs_output_deflator.pdf', '-dpdf', '-r0')
